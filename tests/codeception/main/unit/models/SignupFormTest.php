...
namespace tests\codeception\main\unit\models;

use tests\codeception\main\unit\DbTestCase;
    ...
    public function fixtures()
    {
        return [
            'user' => [
                ...
                'dataFile' => '@tests/codeception/main/unit/fixtures/data/models/user.php',
            ],
        ];
    }
